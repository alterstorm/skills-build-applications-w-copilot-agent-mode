...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create activities
        Activity.objects.create(user='Iron Man', type='run', duration=30, date='2025-11-20')
        Activity.objects.create(user='Captain America', type='cycle', duration=45, date='2025-11-21')
        Activity.objects.create(user='Batman', type='swim', duration=25, date='2025-11-22')
        Activity.objects.create(user='Superman', type='fly', duration=60, date='2025-11-23')
